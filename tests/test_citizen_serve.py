...
<html lang="en" data-prism-page="slice" data-prism-path="/prices/retail-prices">
  <head>
...
<html lang="en" data-prism-page="home" data-prism-path="/">
  <head>
...
def test_preview_does_not_inject_origin(tmp_path: Path) -> None:
    ...
    server = _serve(tmp_path, PreviewHandler)
    try:
