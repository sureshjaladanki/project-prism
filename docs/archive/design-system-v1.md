...
Superseded 2026-09-20 by [design-system.md](../design-system.md) (**v2**). v1 is the contract the welcome ruling replaced — readable and checkable, tone “quiet,” `--measure` on the hero. Do not implement from this file.
