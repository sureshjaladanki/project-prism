...
v1 (quiet desk): [design-system-v1.md](archive/design-system-v1.md). Tone: [design-philosophy.md](design-philosophy.md). Direction: [ui-ux-feedback.md](next/ui-ux-feedback.md).
